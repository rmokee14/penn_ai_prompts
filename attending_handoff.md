...
**Workup notable for:** BCx positive for MRSA on [DATE]. BCx cleared on [DATE]. TTE on [DATE] did not show e/o endocarditis. MRI lumbar spine 1/24 did not show any evidence of infection. Patient's most recent Hgb 7.4, Cr 3.24 (from peak 5.8 on [DATE]. 

**Remains in hospital due to:** Patient needs evidence of full renal recovery. Pending DC to SNF (patient is unable to care for line and have PHIT come to home). Patient will need PICC placed prior to DC.

**Next Steps:** 
- trend creatinine daily for renal recovery after ATN
